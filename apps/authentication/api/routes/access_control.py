...
from apps.authentication.api.views.access_control import MeAV, PermissionListAV, RoleListAV, RoleDetailAV, UserAdminAV, UserAdminDetailAV, ClientAccessAV, ClientAccessDetailAV, ClientAccessOptionsAV, AccessAuditAV

urlpatterns = [
    path('me/',MeAV.as_view()), path('permissions/',PermissionListAV.as_view()),
