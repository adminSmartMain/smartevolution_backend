    ...
    def build(self, validated_rows):
        ...
        for row in validated_rows:
            ...
            rows.append({
               ...
               "opDays": calc.get("operationDays", 0),
            "commission_sf": calc.get("commissionSF", 0),
            "present_value_sf": calc.get("presentValueSF", 0),
            "investor_profit": calc.get("investorProfit", 0),
