...
class BrokerResource(resources.ModelResource):
    class Meta:
        model = Broker
        fields = ('id', 'type_identity', 'document_number', 'first_name', 'last_name', 'email', 'phone_number',)
        import_id_fields = ('id',)

class ClientResource(resources.ModelResource):
    class Meta:
        model = Client
        fields = ('id', 'type_client', 'first_name', 'last_name', 'social_reason', 'email', 'phone_number',)
        import_id_fields = ('id',)

class ContactResource(resources.ModelResource):
    class Meta:
        model = Contact
        fields = ('id', 'client', 'first_name', 'last_name', 'phone_number', 'email',)
        import_id_fields = ('id',)

class LegalRepresentativeResource(resources.ModelResource):
    class Meta:
        model = LegalRepresentative
        fields = ('id', 'client', 'document_number', 'first_name', 'last_name', 'phone_number', 'email',)
        import_id_fields = ('id',)
...
class AccountBalanceHistoryResource(resources.ModelResource):
    class Meta:
        ...
        fields = ('id', 'account', 'old_balance', 'new_balance', 'amount_changed', 'operation_type',)
        import_id_fields = ('id',)
